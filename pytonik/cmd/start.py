            ...
            if d.get("project", "") != "":
                ...
                if os.path.isdir(os.getcwd() + "/" + d.get("project", "")) is False:
                    ...
                    try:
                        ...
                        print(
                            red(
                                "Unable to create project {} directory".format(
...
def make_file(direct, d):
    ...
    for kdir, vdir in itemsv:
        ...
        if kdir.startswith("."):
            ...
            if (
                os.path.isfile(
                    os.getcwd() + "/" + d.get("project", "") + "/" + str(kdir)
                )
                is False
            ):
                ...
                if (
                    ...
                    try:
                        ...
                        print(
                            bold(
                                red(
                                    __("Unable to Set file {} permission ".format(kdir))
                                )
                            )
                        )
                    finally:
                        print(
                            bold(__("File {} Permission Set {}".format(kdir, "0600")))
                        )
            ...
            try:
                os.mkdir(
                    os.getcwd() + "/" + str(d.get("project", "")) + "/" + str(kdir),
                    mode=0o755,
                )
                ...
                if type(direct[kdir]) == list:
                        ...
                        if ldir != "":
                            if (
                                ...
                                try:
                                    ...
                                    print(
                                        bold(
                                            "File {} Created Successfully".format(ldir)
                                        )
                                    )
                                ...
                                try:
                                    ...
                                    print(
                                        bold(
                                            red("Unable to Write File  {}".format(ldir))
                                        )
                                    )
                                    ...
                                    print(
                                        bold(
                                            "File {} Rewrite Successfully".format(ldir)
                                        )
                                    )
                                ...
                                if ldir.startswith("."):
                                    try:
                                        ...
                                        print(
                                            bold(
                                                red(
                                                    "Unable to Set file {} permission ".format(
                                                        ldir
                                                    )
                                                )
                                            )
                    ...
                    if (
                        ...
                        try:
                            ...
                            print(
                                bold(
                                    red(__(("Unable to create File  {}".format(kdir))))
                                )
                            )
                        ...
                        try:
                            ...
                            print(
                                bold(
                                    "File {} Rewrite Successfully".format(direct[kdir])
                                )
                            )
